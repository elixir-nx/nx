...
ffi::Error exla_io_call_cuda_impl(
  ...
  exla::callback_bridge::Result result =
      exla::callback_bridge::InvokeIOCall(
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    exla_io_call_cuda, exla_io_call_cuda_impl,
    ffi::Ffi::Bind()
...
XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "exla_io_call", "CUDA",
                         exla_io_call_cuda);
...
ffi::Error exla_io_call_cuda_stub(
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    exla_io_call_cuda, exla_io_call_cuda_stub,
    ffi::Ffi::Bind()
        .RemainingArgs()
        .Attr<ffi::Span<const int64_t>>("callback_id")
        .Attr<uint64_t>("callback_id_size")
