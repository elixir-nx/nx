...
ffi::Error
exla_io_callback_impl(ffi::RemainingArgs args,
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(exla_io_callback, exla_io_callback_impl,
                              ffi::Ffi::Bind()
                                  .RemainingArgs()
...
XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "exla_io_callback", "Host",
                         exla_io_callback);
