...
static ffi::Error
outfeed_main_custom_call_impl_wrapper(ffi::RemainingArgs remaining_args) {
  return exla_outfeed::outfeed_main_custom_call_impl(remaining_args);
}

XLA_FFI_DEFINE_HANDLER_SYMBOL(outfeed_main_custom_call,
                              outfeed_main_custom_call_impl_wrapper,
