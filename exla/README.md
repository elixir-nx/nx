...
### Common installation issues
  ...
  * Missing CUDA symbols
    * In some cases, you might be compiling a CPU-only version of `:xla` in an environment that has CUDA available. For these cases, you can set the `EXLA_CPU_ONLY=true` environment variable to disable custom CUDA functionality in EXLA.
