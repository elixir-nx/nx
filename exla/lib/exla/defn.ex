defmodule EXLA.Defn do
  ...
  defp to_operator(:is_nan, [arg], out, state), do: EXLA.Op.is_nan(arg, op_type(arg), out.shape, Nx.axes(out), state)
  defp to_operator(:is_infinity, [arg], out, state), do: EXLA.Op.is_infinity(arg, op_type(arg), out.shape, Nx.axes(out), state)
