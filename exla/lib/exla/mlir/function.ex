defmodule EXLA.MLIR.Function do
  ...
  Accepts a tuple `{mesh, dim_shardings}` where mesh is a %Nx.Defn.Mesh{} and dim_shardings
  is a list of lists of axis indices (e.g., `[[0], [1]]`).
  """
  def set_result_sharding(
        %Function{ref: ref},
        result_index,
        {%Nx.Defn.Mesh{name: mesh_name}, dim_shardings}
      ) do
    ...
    EXLA.NIF.mlir_set_function_result_attribute(ref, result_index, "sdy.sharding", mesh_name, dims)
  end
end
