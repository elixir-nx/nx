...
// Elixir caller (Torchx.Backend.to_pointer/2).
...
int get_ipc_handle(const char *, size_t, mode_t) { return -1; }

int open_existing_ipc_handle(const char *, int *) { return -1; }

void *open_ipc_handle(int, size_t, int) { return nullptr; }

int close_ipc_handle(int, void *, const char *, size_t) { return -1; }

int close_imported_ipc_handle(int, void *, size_t) { return -1; }
