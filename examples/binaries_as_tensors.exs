...
shape_reference = Exla.NIF.make_shape(dtype, shape)
...
shaped_buffer = Exla.NIF.binary_to_shaped_buffer(bin, shape_reference)

literal = Exla.NIF.shaped_buffer_to_literal(shaped_buffer)
