defmodule Nx.Defn do
  ...
  anonymous functions, or tuples of tensors and numbers. To pass any
  other values to numerical definitions, they must be declared as
  default arguments (see next subsection).
