defmodule Nx.Shape do
  ...
  ### Error cases
      ...
      ** (ArgumentError) invalid padding configuration, rank of padding configuration and shape must match
      ...
      iex> Nx.Shape.pad({1}, [{0, 0, -1}])
      ** (ArgumentError) invalid padding configuration, interior padding cannot be negative, got: {0, 0, -1}
  """
  ...
  defp padded_dims([s | shape], [{edge_low, edge_high, interior} | config], acc) do
    if interior < 0 do
      raise ArgumentError, "invalid padding configuration, interior padding" <>
            " cannot be negative, got: #{inspect({edge_low, edge_high, interior})}"
    end
  ...
  ### Examples
      ...
      iex> Nx.Shape.coords_to_i({3, 3, 3}, {0, 0, 0})
      0

      iex> Nx.Shape.coords_to_i({3, 3, 3}, {2, 2, 2})
      26

      iex> Nx.Shape.coords_to_i({3, 3, 3}, {1, 0, 0})
      9
  """
  def coords_to_i({}, {}) do
    0
